...
using System.Data;
using VicStelmak.CIAA.Infrastructure.Identity.Models;
...
namespace VicStelmak.CIAA.Infrastructure.Identity
{
    ...
    public class IdentityManagement
    {
        ...
        public IdentityManagement(UserManager<CustomIdentityUser> userManager, RoleManager<CustomIdentityRole> roleManager)
        {
        ...
        public IEnumerable<CustomIdentityUserModel> GetUsers(string? filter = null)
        {
            filter = filter?.Trim();
            ...
            var result = query.ToArray().Select(u => new CustomIdentityUserModel
            {
                Id = u.Id,
                Email = u.Email,
        ...
        public async Task<IdentityManagementResponse> CreateUser(string userName, string name, string email, string password)
        {
            ...
            var response = new IdentityManagementResponse();
            var user = new CustomIdentityUser() { Email = email, UserName = userName };
        ...
        public async Task<CustomIdentityUser> GetUser(string id)
        {
        ...
        public async Task<IdentityManagementResponse> UpdateUser(string id, string email, bool locked, string[] roles, List<KeyValuePair<string, string>> claims)
        {
            if (string.IsNullOrWhiteSpace(id))
                throw new ArgumentNullException("id", "The argument id cannot be null or empty.");
        ...
        /// <returns>Response object.</returns>
        /// <exception cref="ArgumentNullException">When any of the arguments are not provided, an ArgumentNullException will be thrown.</exception>
        public async Task<IdentityManagementResponse> DeleteUser(string id)
        {
            if (string.IsNullOrWhiteSpace(id))
                throw new ArgumentNullException("id", "The argument id cannot be null or empty.");
        ...
        /// <returns>Response object.</returns>
        /// <exception cref="ArgumentNullException">When any of the arguments are not provided, an ArgumentNullException will be thrown.</exception>
        public async Task<IdentityManagementResponse> ResetPassword(string id, string password, string verify)
        {
            if (string.IsNullOrWhiteSpace(id))
                throw new ArgumentNullException("id", "The argument id cannot be null or empty.");
        ...
        public IEnumerable<CustomIdentityRoleModel> GetRoles(string? filter = null)
        {
            ...
            // Execute the query and set properties.
            var result = query.ToArray().Select(r => new CustomIdentityRoleModel
            {
                Id = r.Id,
                Name = r.Name,
                //Key/Value props not camel cased (https://github.com/dotnet/corefx/issues/41309)
        ...
        /// <returns>Response object.</returns>
        /// <exception cref="ArgumentNullException">When any of the arguments are not provided, an ArgumentNullException will be thrown.</exception>
        public async Task<IdentityManagementResponse> CreateRole(string name)
        {
            if (string.IsNullOrWhiteSpace(name))
                throw new ArgumentNullException("name", "The argument name cannot be null or empty.");

            var response = new IdentityManagementResponse();
            var role = new CustomIdentityRole(name);
        ...
        /// <returns>Response object.</returns>
        /// <exception cref="ArgumentNullException">When any of the arguments are not provided, an ArgumentNullException will be thrown.</exception>
        public async Task<IdentityManagementResponse> UpdateRole(string id, string name, List<KeyValuePair<string, string>> claims)
        {
            if (string.IsNullOrWhiteSpace(id))
                throw new ArgumentNullException("id", "The argument id cannot be null or empty.");
        ...
        /// <returns>Response object.</returns>
        /// <exception cref="ArgumentNullException">When any of the arguments are not provided, an ArgumentNullException will be thrown.</exception>
        public async Task<IdentityManagementResponse> DeleteRole(string id)
        {
            if (string.IsNullOrWhiteSpace(id))
                throw new ArgumentNullException("id", "The argument id cannot be null or empty.");
